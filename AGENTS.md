...
Modern React/Next.js with Server Components. TypeScript strict mode. Principles over framework-specific APIs. No filler words, apologies, or hedging. Code first, explanations when asked.
...
- Prefer generic, reusable components when possible
